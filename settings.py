...
GEO_INVITED_USER_WEIGHT = int(os.getenv('GEO_INVITED_USER_WEIGHT'))
GEO_RATING_USERS_COUNT = int(os.getenv('GEO_RATING_USERS_COUNT'))

NOTIFICATION_START_TIME = int(os.getenv('NOTIFICATION_START_TIME'))
NOTIFICATION_END_TIME = int(os.getenv('NOTIFICATION_END_TIME'))
